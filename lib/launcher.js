...
function launch(options) {
    ...
    */
    function createWindow() {
        ...
        if (target === '' && opts.defaultPath) {
            // Invalid, empty target, let's just create a window from default
            wm.createWindow(opts.defaultPath);
            return;
        }
    ...
    app.on('window-all-closed', () => {
        ...
        // NOTE: Dealing with some bugs, for now just quitting in all cases. On
        // OS X it is common for applications and their menu bar to stay active
