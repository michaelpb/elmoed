...
class ModuleBase {
    ...
    */
    ...
    on(channel, callback) {
        // TODO: should move channel construction to WindowManager
        const { windowID } = this.windowInfo;
        const fullchannel = this.manager
            .winChannel(windowID, `${this.path}:${channel}`);
